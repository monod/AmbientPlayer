...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.playing = NO;
        self.frontView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, frame.size.width, frame.size.height)];
        ...
        [self.frontView addSubview:_cover];
        ...
        [self.frontView addSubview:self.levelMeter];
